...
const CartItems = () => {
  ...
  return (
    <section className="max_padd_container pt-28">
      <table className="w-full mx-atuo">
        <thead>
          <tr className="bg-slate-900/10 regular-18 sm:regular-21 text-start py-21">
            ...
            if (cartItems[e.id] > 0) {
              return (
                ...
                >
                  ...
                  <td>
                    <div className="bold-22 flexCenter">
      ...
      {/* cart details */}
      <div className="flex flex-col gap-20 my-16 p-8 md:flex-row rounded-md bg-white w-full mx-w-[666px]">
