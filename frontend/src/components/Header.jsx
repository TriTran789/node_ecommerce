...
const Header = () => {
  ...
  return (
    ...
    <header className="fixed z-10 bg-white left-0 top-0 ring-1 ring-slate-900/5 w-full px-6 lg:px-20">
      <div className="px-4 flexBetween py-3 max-xs:px-2">
        ...
        <Navbar
          containerStyles={`${
            menuOpened
              ? "flex flex-col items-start gap-y-12 fixed top-20 right-8 p-12 bg-white rounded-3xl shadow-md ring-1 ring-slate-900/5 transition-all duration-300"
              : "flex flex-col items-start gap-y-12 fixed top-20 -right-[100%] p-12 bg-white rounded-3xl shadow-md ring-1 ring-slate-900/5 transition-all duration-300"
          }`}
        />
        {/* button */}
        <div className="flexBetween sm:gap-x-6 bold-16">
          ...
          <div className="flexBetween sm:gap-x-6">
            ...
            {/* <NavLink
              to={"logout"}
              className={"flexCenter btn_secondary_rounded gap-x-2 medium-16"}
            >
